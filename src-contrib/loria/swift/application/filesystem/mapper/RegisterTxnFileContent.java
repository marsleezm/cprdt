...
public class RegisterTxnFileContent extends RegisterTxnLocal<StringCopyable> implements TextualContent {
    ...
    public RegisterTxnFileContent(CRDTIdentifier id, TxnHandle txn, CausalityClock clock,
            RegisterVersioned<StringCopyable> creationState, StringCopyable val, long lamportClock) {
