...
public class AmazonS3Upload {
    ...
    private void init() throws Exception {
        credentials = new PropertiesCredentials(AmazonMachine.class.getResourceAsStream("AwsCredentials.properties"));
    ...
    public void createBucketIfNotPresent() {
        /*
         * for (Bucket bucket : s3.listBuckets()) { if
         * (bucket.getName().equals(bucketName)) { return; } }
         */
