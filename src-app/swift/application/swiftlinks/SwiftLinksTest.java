...
public class SwiftLinksTest {
    ...
    public static void main(String[] args) {
        ...
        SwiftLinks client = new SwiftLinks(clientServer, IsolationLevel.SNAPSHOT_ISOLATION, CachePolicy.STRICTLY_MOST_RECENT, clientServer.getSessionId());
