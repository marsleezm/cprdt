...
public class LogootTxnLocalTest {
    ...
    public void updateTest() {
        i.set("Toto\ngo to the \nbeach.\n");
        assertEquals("Toto\ngo to the \nbeach.\n", i.getText());
        LogootIdentifier id1 = i.getDoc().idTable.get(1), id2 = i.getDoc().idTable.get(2), id3 = i.getDoc().idTable
                .get(3);
    ...
    public void idTestInsert() {
        i.set("Toto\ngo to the \nbeach.\n");
        LogootIdentifier id1 = i.getDoc().idTable.get(1), id2 = i.getDoc().idTable.get(2);
        i.set("Toto\ndon't\ngo to the \nbeach.\n");
        LogootIdentifier id1b = i.getDoc().idTable.get(1), id2b = i.getDoc().idTable.get(2), id3b = i.getDoc().idTable
                .get(3);
    ...
    public void idTestDelete() {
        i.set("Toto\ngo to the \nbeach.\n");
        LogootIdentifier id1 = i.getDoc().idTable.get(1), id3 = i.getDoc().idTable.get(3);
        i.set("Toto\nbeach.\n");
        LogootIdentifier id1b = i.getDoc().idTable.get(1), id2b = i.getDoc().idTable.get(2);
        assertEquals(id1, id1b);
