...
wantedOps = ['READ_LINKS', 'READ_COMMENTS'] as Set

site = 'emory.edu'

key = 'querycache-notime'
processDir(30, 1000, DIR, key, "*", "exact match")

key = 'querycache-5sec'
processDir(30, 1000, DIR, key, "*", "5 seconds cache")

key = 'querycache-10sec'
processDir(30, 1000, DIR, key, "*", "10 seconds cache")

key = 'querycache-30sec'
processDir(30, 1000, DIR, key, "*", "30 seconds cache")

key = 'querycache-nonlazy'
processDir(30, 1000, DIR, key, "*", "non lazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-querycache-time'
