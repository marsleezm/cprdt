...
wantedOps = [
    'VOTE_LINK',
    'VOTE_COMMENT'] as Set
processDir.call(30, 1000, DIR, key, "*", "votes  + cs")

key = '-lazy-local'
wantedOps = [
    'VOTE_LINK',
    'VOTE_COMMENT'] as Set
processDir.call(30, 1000, DIR, key, "*", "votes + lazy")

key = '-nonlazy-local'
wantedOps = [
    'VOTE_LINK',
    'VOTE_COMMENT'] as Set
processDir.call(30, 1000, DIR, key, "*", "votes + non lazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-updates-vote-site'+siteName
