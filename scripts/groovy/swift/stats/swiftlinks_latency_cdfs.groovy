...
processDir(30, 1000, DIR, key, "*", "reads + cs")

wantedOps = [
    'POST_LINK',
    'POST_COMMENT',
    'VOTE_LINK'] as Set
processDir.call(30, 1000, DIR, key, "*", "updates  + cs")

key = '-lazy-local'
wantedOps = ['READ_LINKS', 'READ_COMMENTS'] as Set
processDir(30, 1000, DIR, key, "*", "reads + lazy")

wantedOps = [
    'POST_LINK',
    'POST_COMMENT',
    'VOTE_LINK'] as Set
processDir.call(30, 1000, DIR, key, "*", "updates + lazy")

key = '-nonlazy-local'
wantedOps = ['READ_LINKS', 'READ_COMMENTS'] as Set
processDir(30, 1000, DIR, key, "*", "reads + nonlazy")

wantedOps = [
    'POST_LINK',
    'POST_COMMENT',
    'VOTE_LINK'] as Set
processDir.call(30, 1000, DIR, key, "*", "updates + nonlazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-site'+siteName
