...
key = '-cs'
wantedOps = ['READ_COMMENTS'] as Set
processDir(30, 1000, DIR, key, "*", "reading comments + cs")

key = '-lazy-local'
wantedOps = ['READ_COMMENTS'] as Set
processDir(30, 1000, DIR, key, "*", "reading comments + lazy")

key = '-nonlazy-local'
wantedOps = ['READ_COMMENTS'] as Set
processDir(30, 1000, DIR, key, "*", "reading comments + non lazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-read-comments-site'+siteName
