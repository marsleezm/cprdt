...
processDir(0, 10, DIR, key, "*", "reading comments + lazy")

key = '-nonlazy-local'
wantedOps = ['READ_COMMENTS'] as Set
processDir(0, 10, DIR, key, "*", "reading comments + non lazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-read-comments-warmup-site'+siteName
