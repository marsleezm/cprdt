...
wantedOps = [
    ...
    'POST_COMMENT',
    'VOTE_COMMENT'] as Set
processDir.call(30, 1000, DIR, key, "*", "Scout")
...
wantedOps = [
    ...
    'POST_COMMENT',
    'VOTE_COMMENT'] as Set
processDir.call(30, 1000, DIR, key, "*", "Lazy fetch")
...
wantedOps = [
    ...
    'POST_COMMENT',
    'VOTE_COMMENT'] as Set
processDir.call(30, 1000, DIR, key, "*", "Non-lazy fetch")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-updates-site'+siteName
