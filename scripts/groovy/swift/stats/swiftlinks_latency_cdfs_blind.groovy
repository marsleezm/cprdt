...
if (args.length < 1) {
    println "usage: script <root_dir_with_logs> <site> <op>"
    System.exit(1)
}
...
wantedOps = [
    OP] as Set
processDir.call(30, 1000, DIR, key, "*", "Lazy")

key = '-nonlazy'
wantedOps = [
    OP] as Set
processDir.call(30, 1000, DIR, key, "*", "Non-lazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-'+ opName +'-site'+siteName
