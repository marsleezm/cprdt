...
processDir(0, 10, DIR, key, "*", "reading links + lazy")

key = '-nonlazy-local'
wantedOps = ['READ_LINKS'] as Set
processDir(0, 10, DIR, key, "*", "reading links + non lazy")
...
String outputFile = '/tmp/sosp/SwiftLinks-latency-cdfs-read-links-warmup-site'+siteName
